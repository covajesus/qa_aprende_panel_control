    ...
    methods: {
        ...
        async submit() {
            ...
            if (token) {
                ...
                try {
                    const response = await axios.post(
                        "https://qa.paneldecontrolaprende.cl/api/user/" + this.$route.params.id,
                        formData,
                        {
                            headers: {
                                Authorization: `Bearer ${token}`,
        ...
        async getData() {
            ...
            if(token) {
                try {
                    const response = await axios.get("https://qa.paneldecontrolaprende.cl/api/user/" + this.$route.params.id, {
                        headers: {
                            Authorization: `Bearer ${token}`,
                        },
                    });

                    this.rol_input = response.data.data.rol_id;
                    this.name_input = response.data.data.name;
                } catch (error) {
