        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" v-if="add_user == 1">
...
export default {
            ...
            if (token) {
                try {
                    const response = await axios.get(
                        "https://qa.paneldecontrolaprende.cl/api/user/",
                        {
                            headers: {
        ...
        deleteUser(id) {
            ...
            if (token) {
                if (confirm("¿Estás seguro de que deseas eliminar el registro?")) {
                    ...
                    this.$axios.delete("api/user/" + id, { headers }).then((res) => {
                        this.getData();
                    });
                }
            } else {
    ...
    async mounted() {
        ...
        this.created_user = localStorage.getItem(
            'created_user',
        )

        if (this.created_user == 1) {
