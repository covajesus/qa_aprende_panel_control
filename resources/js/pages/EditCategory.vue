    ...
    methods: {
        ...
        async getSelectedRegionsCommunes() {
            ...
            if(token) {
                ...
                try {
                    const response = await axios.get(
                    "https://qa.paneldecontrolaprende.cl/api/category_commune/" + this.$route.params.id,
                    {
                        headers: {
                        accept: "application/json",
                        Authorization: `Bearer ${token}`,
        ...
        async submit() {
            ...
            if(token) {
                ...
                try {
                    const response = await axios.post(
                        "https://qa.paneldecontrolaprende.cl/api/category/" + this.$route.params.id,
                        formData,
                        {
                            headers: {
                                Authorization: `Bearer ${token}`,
        ...
        async getData() {
            ...
            if(token) {
                ...
                try {
                    const response = await axios.get(
                        "https://qa.paneldecontrolaprende.cl/api/category_region/" + this.$route.params.id,
                        {
                            headers: {
                                accept: "application/json",
                                Authorization: `Bearer ${token}`,
